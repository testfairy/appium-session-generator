...
`;
    // TODO : differentiate for perfecto
    this.append(generatedJsLine);
  ...
  visitTestBegin(platform: Platform) {
    ...
    let deviceIOS = `var desired = _.clone(require("./helpers/caps").iOSSimulator);
    desired.app = __dirname + "/session/app.zip";`;
    let deviceAndroid = `var desired = _.clone(require("./helpers/caps").androidEmulator);
